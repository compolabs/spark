...
const UiKit: React.FC<IProps> = () => {
    return <Root>
        ...
        <Row mainAxisSize="fit-content">
            ...
            <SizedBox width={16}/>
            <Column style={{flex: 1}}>
                <Button primary disabled>Primary filled button</Button>
                <SizedBox height={16}/>
                <Button secondary disabled>Secondary filled button</Button>
                <SizedBox height={16}/>
                <Button disabled>Neutral filled button</Button>
                <SizedBox height={16}/>
                <Button outline disabled>Outline button</Button>
            </Column>
        </Row>
        <SizedBox height={32}/>
        <ButtonGroup>
